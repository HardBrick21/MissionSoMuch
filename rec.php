...
<body>
    ...
    <div class="jumbotron">
      ...
      <div class="container">
		  ...
		  <li role="presentation" class="active"><a href="rec.php" >已接受任务</a></li>
              ...
              <?php 
				 ...
				 //    if(!$result_pub) die("<h4 class='h4'>查询失败</h4>".$sql);
				    ...
				    if(!$result_rec) die("<h4 class='h4'>查询失败</h4>".$sql);
	                  ...
	                  while ($rows = mysqli_fetch_array($result_rec,MYSQLI_ASSOC)) {
	                    # code...
	                    //var_dump($rows);
	                    if ($rows['missionSta'] == '已接受'){
	                      echo "<tr>";
	                      ...
	                      // echo "<td class='active'><a href=\"comMission.php?missionID={$rows['missionID']}\" 
	                      //       class=\"label label-danger\">完 成</a></td>";
	                      echo "</tr>";
	                    }
